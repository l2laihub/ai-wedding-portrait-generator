-- Engagement Portraits Themes - Corrected
...
BEGIN
    ...
    IF engagement_package_id IS NOT NULL THEN
        ...
        (
            ...
            '["soft_pastels", "cream", "blush", "sage_green", "warm_neutrals"]',
            '["classic_portrait_photography", "sophisticated_elegance", "indoor_natural_light"]',
            true,
            false,
            1,
            10
        ...
        (
            ...
            '["golden_tones", "warm_earth", "sunset_hues", "natural_greens"]',
            '["golden_hour_photography", "outdoor_natural_light", "candid_moments"]',
            true,
            false,
            2,
            9
        ...
        (
            ...
            '["urban_grays", "modern_blacks", "city_blues", "metallic_accents"]',
            '["urban_photography", "cityscape_portraits", "modern_architecture"]',
            true,
            false,
            3,
            8
        ...
        (
            ...
            '["rustic", "natural", "carefree", "authentic"]',
            '["earth_tones", "barn_red", "country_blues", "natural_browns"]',
            '["country_lifestyle", "rustic_photography", "natural_environments"]',
            true,
            false,
            4,
            7
        ...
        (
            ...
            '["breezy", "romantic", "playful", "carefree"]',
            '["ocean_blues", "sandy_beiges", "coral_pinks", "sunset_oranges"]',
            '["beach_photography", "coastal_lifestyle", "sunset_portraits"]',
            true,
            false,
            5,
            8
        ...
        (
            ...
            '["magical", "serene", "intimate", "natural"]',
            '["forest_greens", "earthy_browns", "moss_tones", "dappled_light"]',
            '["forest_photography", "woodland_portraits", "natural_lighting"]',
            true,
            true,
            6,
            6
        ...
        (
            ...
            '["fresh", "vibrant", "colorful", "romantic"]',
            '["garden_greens", "floral_pinks", "spring_pastels", "blooming_colors"]',
            '["botanical_photography", "garden_portraits", "floral_compositions"]',
            true,
            false,
            7,
            7
        ...
        (
            ...
            '["nostalgic", "classic", "timeless", "charming"]',
            '["vintage_sepia", "retro_pastels", "classic_reds", "antique_golds"]',
            '["vintage_photography", "retro_styling", "period_aesthetics"]',
            true,
            true,
            8,
            5
        ...
        (
            ...
            '["cozy", "intimate", "authentic", "comfortable"]',
            '["warm_neutrals", "cozy_browns", "soft_grays", "home_comfort"]',
            '["lifestyle_photography", "intimate_portraits", "natural_home_lighting"]',
            true,
            false,
            9,
            6
        ...
        (
            ...
            '["adventurous", "energetic", "active", "confident"]',
            '["nature_greens", "mountain_blues", "earth_tones", "adventure_gear"]',
            '["adventure_photography", "outdoor_action", "landscape_integration"]',
            true,
            false,
            10,
            5
        ...
        (
            ...
            '["cultural", "traditional", "respectful", "elegant"]',
            '["cultural_rich", "heritage_golds", "traditional_reds", "ceremonial_colors"]',
            '["cultural_photography", "heritage_portraits", "traditional_aesthetics"]',
            true,
            false,
            11,
            4
        ...
        (
            ...
            '["cozy", "magical", "seasonal", "warm"]',
            '["winter_whites", "cozy_reds", "snow_blues", "warm_golds"]',
            '["winter_photography", "seasonal_portraits", "snow_lighting"]',
            true,
            false,
            12,
            4
        ...
        SET 
            ...
            style_modifiers = EXCLUDED.style_modifiers,
            color_palette = EXCLUDED.color_palette,
            inspiration_references = EXCLUDED.inspiration_references,
