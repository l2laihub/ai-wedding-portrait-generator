/**
 * PromptBuilder - Advanced Template Engine for Portrait Generation
 * 
...
import { ThemeManager } from '../config/themes.config.js';
...
export class PromptBuilder {
   ...
   * @param {string} params.template - Base template from admin system
   * @param {Object} params.selectedTheme - Theme object or theme name/id
   * @param {string} params.portraitType - 'single', 'couple', 'family'
   * @param {string} params.userInput - Optional custom user prompt
   * @param {number} params.familyMemberCount - Number of family members (for family type)
   * @param {Object} params.additionalVars - Additional custom variables
   ...
   * @param {string|Object} themeInput - Theme name, ID, or object
...
export const PromptBuilderFactory = {
  /**
   * Create a new PromptBuilder instance
   */
  create(options = {}) {
    return new PromptBuilder().configure(options);
  },

  /**
   * Create a configured instance for legacy compatibility
   */
  createLegacyCompatible() {
    return new PromptBuilder().configure({
  ...
  /**
   * Create a strict instance for new implementations
   */
  createStrict() {
    return new PromptBuilder().configure({
      validateParams: true,
