      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center">
          ...
          <div className="flex justify-center gap-4 mb-6">
            ...
            <a
              href="https://www.facebook.com/profile.php?id=61580869858911"
              target="_blank"
              rel="noopener noreferrer"
              className="w-10 h-10 bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg flex items-center justify-center hover:shadow-lg transition-all group"
              aria-label="Facebook"
            >
