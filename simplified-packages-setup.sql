-- =====================================================
-- SIMPLIFIED PHOTO PACKAGES SYSTEM
-- Creates 4 main packages with themes and prompts
-- =====================================================

-- Step 1: Update photo_packages table with base prompts for each portrait type
ALTER TABLE photo_packages 
ADD COLUMN IF NOT EXISTS single_prompt_template TEXT,
ADD COLUMN IF NOT EXISTS couple_prompt_template TEXT,
ADD COLUMN IF NOT EXISTS family_prompt_template TEXT;
...
-- Step 3: Create 4 main photo packages
INSERT INTO photo_packages (
    name, slug, description, category, is_active, is_featured, 
    single_prompt_template, couple_prompt_template, family_prompt_template,
...
-- Success message
SELECT 'Simplified Photo Packages system created! ✅' as status,
