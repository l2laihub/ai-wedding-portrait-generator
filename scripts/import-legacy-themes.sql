-- Import All Legacy Themes to Enhanced Database System
...
-- 2. Classic & Timeless Wedding (already exists, skip)

-- 3. Rustic Barn Wedding (already exists, skip)
...
-- 6. Fairytale Castle Wedding (already exists, skip)
...
FROM wedding_styles 
WHERE id IN (
  'bohemian-beach', 'vintage-victorian', 'modern-minimalist', 
  'enchanted-forest', 'tropical-paradise', 'japanese-cherry-blossom',
  'steampunk-victorian', 'disco-70s-glam', 'hollywood-red-carpet'
)
ORDER BY name;